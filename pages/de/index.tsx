      ...
      <main className="min-h-screen text-white px-6 py-10">
        <nav className="flex justify-between items-center mb-12 flex-wrap">
          ...
          <ul className="flex gap-6 text-sm">
            <li><Link href="/de/don">Spende</Link></li>
        ...
        <section className="text-center max-w-3xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mb-6 bg-gradient-to-r from-purple-400 via-fuchsia-500 to-blue-500 text-transparent bg-clip-text drop-shadow-xl">
            SPENDEN SIE IN KRYPTO UND ERHALTEN SIE EINEN EXKLUSIVEN LEITFADEN
          </h1>
        ...
        <div className="text-center mt-12">
          <p className="text-sm text-gray-400">
            Nach Ihrer Spende füllen Sie bitte das Formular im Bereich <Link href="/de/confirmation" className="underline text-indigo-300">Bestätigung</Link> aus.
          </p>
        </div>
      </main>
    </>
