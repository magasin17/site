...
export default function Confirmation() {
  ...
  return (
    <main className="min-h-screen px-6 py-10 text-white">
      ...
      <form onSubmit={handleSubmit} action="https://formspree.io/f/xeoabrky" method="POST" className="max-w-xl mx-auto space-y-6">
        ...
        <input type="email" name="email" placeholder="E-Mail" required className="w-full px-4 py-2 rounded bg-white/10 border border-white/20 focus:outline-none" />
      ...
      <div className="text-center mt-10 text-sm text-gray-400">
        <p>Sobald Ihre Bestätigung validiert wurde, erhalten Sie den Guide per E-Mail. Falls Sie ihn nicht im Posteingang finden, überprüfen Sie bitte Ihren Spam-Ordner oder füllen Sie das Formular erneut aus.</p>
      </div>
    </main>
  );
}