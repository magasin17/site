    ...
    <main className="min-h-screen px-6 py-10 text-white">
      ...
      <div className="text-center mt-12">
        <p className="text-sm text-gray-400">
          Nach Ihrer Spende füllen Sie bitte das Formular im Bereich{' '}
          <Link href="/de/confirmation" className="underline text-indigo-300">
            Bestätigung
          </Link>{' '}
          aus.
        </p>
