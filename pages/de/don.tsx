    ...
    <main className="min-h-screen px-6 py-10 text-white">
      ...
      <div className="grid sm:grid-cols-3 gap-6 max-w-5xl mx-auto">
        <div className="bg-white/5 backdrop-blur-md p-6 rounded-2xl shadow-xl text-center">
          ...
          <p className="text-sm text-indigo-300">Bitcoin-Adresse</p>
        ...
        <div className="bg-white/5 backdrop-blur-md p-6 rounded-2xl shadow-xl text-center">
          ...
          <p className="text-sm text-indigo-300">Ethereum-Adresse</p>
        ...
        <div className="bg-white/5 backdrop-blur-md p-6 rounded-2xl shadow-xl text-center">
          ...
          <p className="text-sm text-indigo-300">Solana-Adresse</p>
      ...
      <div className="text-center mt-12">
        <p className="text-sm text-gray-400">
          Nach Ihrer Spende füllen Sie bitte das Formular im Abschnitt Bestätigung aus.
        </p>
      </div>
    </main>
  );
