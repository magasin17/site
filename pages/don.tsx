      ...
      <section className="max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gray-900 p-6 rounded-xl text-center shadow-md">
            <img src="https://cryptologos.cc/logos/bitcoin-btc-logo.png" alt="Bitcoin" className="w-12 h-12 mx-auto mb-2" />
          ...
          <div className="bg-gray-900 p-6 rounded-xl text-center shadow-md">
            <img src="https://cryptologos.cc/logos/ethereum-eth-logo.png" alt="Ethereum" className="w-12 h-12 mx-auto mb-2" />
          ...
          <div className="bg-gray-900 p-6 rounded-xl text-center shadow-md">
            <img src="https://cryptologos.cc/logos/solana-sol-logo.png" alt="Solana" className="w-12 h-12 mx-auto mb-2" />
