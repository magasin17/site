  ...
  return (
    <main className="min-h-screen px-6 py-10 text-white">
      ...
      <form onSubmit={handleSubmit} action="https://formspree.io/f/xeoabrky" method="POST" className="max-w-xl mx-auto space-y-6">
        ...
        <button type="submit" className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-6 py-2 rounded transition">Send</button>
        {submitted && <p className="text-green-400">Confirmation sent successfully!</p>}
      </form>
      <div className="text-center mt-10 text-sm text-gray-400">
        <p>Once your confirmation is validated, you will receive your guide by email. If you do not see it in your inbox, please check your spam folder or fill out this form again.</p>
      </div>
    </main>
  );
}