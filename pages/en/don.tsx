      ...
      <main className="relative min-h-screen text-white px-6 py-16 overflow-x-hidden">
        <section className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-gray-300 mb-2">
            Minimum required amount: <span className="text-white font-semibold">$49</span>
          </p>
          <p className="mb-10 text-gray-300">Contribute via one of the addresses below:</p>
          ...
          <p className="mt-4 text-sm text-gray-400">
            Once your donation is completed, don't forget to fill out the <Link href="/en/confirmation" className="underline text-indigo-300">Confirmation</Link> form.
          </p>
        </section>
      </main>
    </>
