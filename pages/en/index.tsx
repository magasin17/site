...
export default function Home() {
  return (
    <>
      <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', background: "url('/hero-bg.jpg') center/cover no-repeat", zIndex: -10 }} />
      <main className="min-h-screen text-white px-6 py-10">
        ...
        <section className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg text-gray-300 mb-4">Contribute in BTC, ETH or SOL and receive an exclusive guide:</p>
          ...
          <div className="mt-10">
            <Link href="/en/don" className="inline-block bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 px-8 py-3 rounded-full text-white font-semibold shadow-xl transition">
              DONATE
            </Link>
          </div>
        </section>
        ...
        <div className="text-center mt-12">
          <p className="text-sm text-gray-400">
            After your donation, please fill in the <Link href="/en/confirmation" className="underline text-indigo-300">Confirmation</Link> form.
          </p>
        </div>
      </main>
    </>
