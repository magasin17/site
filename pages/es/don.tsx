      ...
      <main className="relative min-h-screen text-white px-6 py-16 overflow-x-hidden">
        <section className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-gray-300 mb-2">
            Monto mínimo requerido: <span className="text-white font-semibold">$49</span>
          </p>
          <p className="mb-10 text-gray-300">Contribuye a través de una de las siguientes direcciones:</p>
          ...
          <p className="mt-4 text-sm text-gray-400">
            Una vez realizada tu donación, no olvides completar el formulario en la sección <Link href="/es/confirmation" className="underline text-indigo-300">Confirmación</Link>.
          </p>
        </section>
      </main>
    </>
